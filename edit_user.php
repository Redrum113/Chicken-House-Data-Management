...
if (isset($_POST["submit"])) {
  if ($_POST["id"] == "") {
    saveUser($_POST["firstname"], $_POST["lastname"], $_POST["address"], $_POST["telephone"], $_POST["email"], $_POST["status"], $_POST["username"], $_POST["password"], $_FILES["profile"]["name"]);
  } else {
    editUser($_POST["id"], $_POST["firstname"], $_POST["lastname"], $_POST["address"], $_POST["telephone"], $_POST["email"], $_POST["status"], $_POST["username"], $_POST["password"], $_FILES["profile"]["name"]);
  }
}
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">รูปภาพโปรไฟล์</label>
